...
export default function Procurement() {
  return (
    <section id="procurement" className="relative overflow-hidden bg-white py-24 lg:py-32">
      <div className="pointer-events-none absolute -left-40 top-20 h-96 w-96 rounded-full bg-copper-600/10 blur-[120px]" />
      <div className="pointer-events-none absolute -right-40 bottom-0 h-96 w-96 rounded-full bg-navy-600/10 blur-[120px]" />
          ...
          {PROCESS.map((step, i) => (
            <Reveal as="article" key={step.step} delay={(i % 4) * 0.08} className="relative">
              ...
              <div className="relative flex items-center gap-4">
                <div className="relative z-10 inline-flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-lg border border-line bg-gradient-to-br from-graphite-800 to-navy-900 text-copper-400 shadow-card">
